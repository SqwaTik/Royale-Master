...
private double velocityThreshold = 0.001D;
...
public boolean shouldStopMovement() { return this.stopMovement; }
public boolean shouldStopSprint() { return this.stopSprint; }
public boolean shouldCloseInventory() { return this.closeInventory; } public double getVelocityThreshold() {
return this.velocityThreshold;
}
public int randomPreStopDelay() { return random(this.preStopDelayMin, this.preStopDelayMax); }
public int randomWaitStopDelay() { return random(this.waitStopDelayMin, this.waitStopDelayMax); }
public int randomPreSwapDelay() { return random(this.preSwapDelayMin, this.preSwapDelayMax); }
public int randomPostSwapDelay() { return random(this.postSwapDelayMin, this.postSwapDelayMax); } public int randomResumeDelay() {
return random(this.resumeDelayMin, this.resumeDelayMax);
}
