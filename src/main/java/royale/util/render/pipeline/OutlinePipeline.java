...
private static final Identifier PIPELINE_ID = Identifier.of("royale", "pipeline/outline");
private static final Identifier VERTEX_SHADER = Identifier.of("royale", "core/outline");
private static final Identifier FRAGMENT_SHADER = Identifier.of("royale", "core/outline");
...
prepareUniformData(x, y, width, height, fixedScreenWidth, fixedScreenHeight, 2.0F, colors, thicknesses, radii, smoothness);
...
RenderPass renderPass = encoder.createRenderPass(() -> "minecraft:outline_pass", client
