...
private static final Deque<int[]> scissorStack = (Deque)new ArrayDeque<>();
...
int currentGuiScale = mc.getWindow().calculateScaleFactor(requestedScale, mc.forcesUnicodeFont());
